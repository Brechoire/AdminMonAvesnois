    ...
    <div class="container">
        ...
        <div class="d-none d-lg-flex align-items-center mr-3">
            ...
            <a href="index.php" class="mr-10">
                <img alt="Logo" src="assets/media/logos/logo-dark.png" class="max-h-35px" />
            </a>
            <!--end::Logo-->
            <!--begin::Dropdown-->
            <div class="header-switcher dropdown">
                <a href="#" class="btn btn-hover-primary font-weight-bold font-size-sm dropdown-toggle px-6 border-0" data-toggle="dropdown" data-offset="0px,1px" aria-haspopup="true" aria-expanded="false">Retour au site</a>
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                    <form>
                        ...
                        <div class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(assets/media/misc/bg-1.jpg)">
                            ...
                            <button type="button" class="btn btn-success btn-sm">2 produits</button>
                        </div>
                        <!--end::Header-->
                        <!--begin::Scroll-->
            ...
            <div class="topbar-item">
                <div class="btn btn-icon w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    <div class="d-flex text-right pr-3">
                        <span class="text-white font-weight-bolder font-size-sm d-none d-md-inline">Jeranders</span>
                    </div>
                    <span class="symbol symbol-35">
												<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-15">J</span>
											</span>
                </div>
            </div>
            <!--end::User-->
